...
### Polynomial Regressions
allpars<- ParticipantReachmodels(active_reaches, passive_reaches, pause_reaches[33:320,], newnocursor_reaches[33:320,])
      pLogRegression(allpars)
...
metrics<- rbind(Active_metrics, passive_reaches, Pause_metrics, NC_metrics)
...
Reachmodel(newnocursor_reaches, 'No-Cursor', grid = 'skewed', condition = 'nc', ncdata = newnocursor_nocursors, color = colorNC)
