...
FullANOVA<-ANOVAanalysis(ANOVAdata[ANOVAdata$Experiment == 'No-Cursor' | ANOVAdata$Experiment == 'No-CursorI' | ANOVAdata$Experiment == 'Pause',])
FullANOVA
  IndependentT(AllDataRM, 'No-Cursor', 'No-CursorI', 'Reach')
    IndependentT(AllDataRM, 'No-CursorI', 'Pause', 'Reach')
