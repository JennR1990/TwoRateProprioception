...
Ttestdata<- PrepdataforT1(active_reaches, passive_reaches, pause_reaches[33:320,], newnocursor_reaches[33:320,], newnocursor_nocursors, nocursorI_reaches[33:320,],nocursorI_nocursors)
...
ANOVAdata<- PrepdataforANOVA(active_reaches, passive_reaches, pause_reaches[33:320,], newnocursor_reaches[33:320,],newnocursor_nocursors)
ANOVAPdata<- PrepdataforPropANOVA(active_localization,passive_localization)
TtestPdata<- PrepdataforPropT(active_localization, passive_localization)
...
pairtrandom(Ttestdata, 'No-Cursor_No-Cursors', 'No-Cursors')
...
### Polynomial Regressions
allpars<- ParticipantReachmodels1(active_reaches, passive_reaches, pause_reaches[33:320,], newnocursor_reaches[33:320,])
      pLogRegression(allpars)
...
metrics<- rbind(Active_metrics, Passive_metrics, Pause_metrics, NC_metrics, NCI_metrics)
...
```{r real figures}
svglite(file='doc/schedule.svg', width=6, height=4, system_fonts=list(sans = "Arial"))
...
svglite(file='doc/Experiment_2_Figures.svg', width=12, height=4, system_fonts=list(sans = "Arial"))
...
svglite(file='doc/table.svg', width=12, height=2, system_fonts=list(sans = "Arial"))
metricstable()
dev.off()
