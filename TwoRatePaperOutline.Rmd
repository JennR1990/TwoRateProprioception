...
```{r}
Active_AICS<- bootstrapModelAICs(active_reaches,1, 'Active')
Passive_AICS<- bootstrapModelAICs(passive_reaches,1, 'Passive')
Pause_AICS<- bootstrapModelAICs(pause_reaches,1, 'Pause')
NC_AICS<- bootstrapModelAICs(nocursor_reaches,1, 'No-Cursor')
NCI_AICS<- bootstrapModelAICs(nocursorI_reaches, 1,'No-Cursor_I')
```
