...
nocursorI_nocursors<- Loaddata(group='nocursor', task = 'nocursors_NI')
...
```{r}
#Experiment 1:
Ttestdata<- PrepdataforT(active_reaches, passive_reaches)
ANOVAdata<- PrepdataforANOVA(active_reaches, passive_reaches)
...
#Experiment 2:
ANOVAdata<- PrepdataforANOVA(pause_reaches[33:320,], nocursor_reaches[33:320,])
ANOVAPdata<- PrepdataforPropANOVA(active_localization,passive_localization)
Ttestdata<- PrepdataforT(pause_reaches[33:320,], nocursor_reaches[33:320,])
TtestPdata<- PrepdataforPropT(active_localization, passive_localization)
tanalyzedata(Ttestdata)
library("ez")
FullANOVA<-ANOVAanalysis(ANOVAdata)
...
#Experiment 3
ANOVAdata<- PrepdataforANOVA(nocursor_reaches[33:320,],nocursorI_reaches[33:320,])
ANOVAPdata<- PrepdataforPropANOVA(active_localization,passive_localization)
Ttestdata<- PrepdataforT(nocursor_reaches[33:320,],  nocursorI_reaches[33:320,])#, nocursorI_nocursors,nocursor_nocursors,
TtestPdata<- PrepdataforPropT(active_localization, passive_localization)
tanalyzedata(Ttestdata)
library("ez")
FullANOVA<-ANOVAanalysis(ANOVAdata)
...
ANOVAdata<- PrepdataforANOVA(nocursor_nocursors,nocursorI_nocursors)
ANOVAPdata<- PrepdataforPropANOVA(active_localization,passive_localization)
Ttestdata<- PrepdataforT(nocursor_nocursors,  nocursorI_nocursors)#, nocursorI_nocursors,nocursor_nocursors,
TtestPdata<- PrepdataforPropT(active_localization, passive_localization)
tanalyzedata(Ttestdata)
library("ez")
FullANOVA<-ANOVAanalysis(ANOVAdata)
...
ANOVAdata<- PrepdataforANOVA(active_reaches, passive_reaches, pause_reaches[33:320,], nocursor_reaches[33:320,],nocursorI_reaches[33:320,])
ANOVAPdata<- PrepdataforPropANOVA(active_localization,passive_localization)
Ttestdata<- PrepdataforT(active_reaches, passive_reaches, pause_reaches[33:320,], nocursor_reaches[33:320,],  nocursorI_reaches[33:320,])#, nocursorI_nocursors,nocursor_nocursors,
