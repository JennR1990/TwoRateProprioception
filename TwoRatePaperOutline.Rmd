...
```{r real figures}
svglite(file='doc/schedule.svg', width=6, height=8, system_fonts=list(sans = "Arial"))
layout(matrix(c(1,2), nrow=2, byrow=TRUE), heights=c(2,2))
...
Reachmodelnc(nocursor_reaches, nocursor_nocursors, 'No-Cursor')
Reachmodelnc(nocursorI_reaches, nocursorI_nocursors, 'No-Cursor')
Reachmodel(pause_reaches, 'Pause')
dev.off()
...
RegressionPLot3P()
RegressionPLotchange()
fitPropModel(active_reaches, active_localization, colorA)
fitPropModel(passive_reaches, passive_localization, colorPA)
dev.off()
