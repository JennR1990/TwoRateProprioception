...
Individual Data 
```{r}
PlotIndividualdata(pause_reaches[33:320,],3, "Individual Pause Data")
PlotIndividualdata(active_reaches,1, "Individual Active Data")
PlotIndividualdata(passive_reaches,2, "Individual Passive Data")
PlotIndividualdata(nocursor_reaches[33:320,],4, "Individual No-Cursor Data")  # Need to see if this naming and color scheme still works, 4 and 5 thing)
PlotIndividualdata(nocursorI_reaches[33:320,],5, "Individual No-Cursor_I Data") 
```

#Averaged reaches
```{r}
PlotallreachesCI(active_reaches,passive_reaches, pause_reaches[33:320,],newnocursor_reaches[33:320,])# I have already put the two together at this point and the function only works for three data sets now. 
```
...
###comparing 1st block to second block to third block and so on to 6th block
...
svglite(file='doc/Fig 1.svg', width=12, height=8, system_fonts=list(sans = "Arial"))
...
svglite(file='doc/Fig 2.svg', width=12, height=8, system_fonts=list(sans = "Arial"))
...
svglite(file='doc/Fig 3.svg', width=12, height=4, system_fonts=list(sans = "Arial"))
