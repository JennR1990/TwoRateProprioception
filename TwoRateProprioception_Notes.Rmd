...
#Reachmodel(pause_reaches[33:320,])
#Reachmodel(nocursor_reaches[33:320,])
#Reachmodel(active_reaches)
#Reachmodel(passive_reaches)
...
#PlotallTapCI(passive_localization, active_localizations) has no model output
...
#Poneratevstworate(active_reaches)
#Poneratevstworate(passive_reaches)
#Poneratevstworate(pause_reaches)
#Poneratevstworate(nocursor_reaches)
#Active_AICS<- bootstrapAICS(active_reaches, 15)
#Passive_AICS<- bootstrapAICS(passive_reaches, 15)
#Pause_AICS<- bootstrapAICS(pause_reaches, 15)
#NC_AICS<- bootstrapAICS(nocursor_reaches, 15)
